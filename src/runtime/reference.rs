...
use crate::runtime::gpu_decode_metrics::{
    ...
    PackedDecodeMetrics, PackedMlpStageMetrics, ProjectionComparison, finish_packed_decode_metrics,
};
use crate::runtime::gpu_decode_model_state::{HybridQProjCache, LayerTensorNames};
use crate::runtime::gpu_decode_output::DecodeResult;
use crate::runtime::gpu_decode_projection_state::{
    PackedProjectionCache, ResidentGpuVectorAdd, ResidentPackedPairProjection,
};
...
impl ReferenceModel {
    ...
    pub(crate) fn get_or_create_projection_cache(
        &self,
        tensor_name: &str,
        rows: usize,
        cols: usize,
    ...
    pub(crate) fn get_or_create_projection_pair_cache(
        &self,
        cache_key: &str,
        first_name: &str,
        first_rows: usize,
    ...
    #[allow(clippy::too_many_arguments)]
    pub(crate) fn get_or_create_projection_triplet_cache(
        &self,
        cache_key: &str,
        first_name: &str,
        first_rows: usize,
    ...
    pub(crate) fn get_or_create_projection_gpu(
        &self,
        tensor_name: &str,
        packed: &PackedProjectionCache,
    ...
    pub(crate) fn get_or_create_projection_gpu_raw_f32(
        &self,
        tensor_name: &str,
        packed: &PackedProjectionCache,
    ) -> Result<CachedProjectionGpuCacheEntry, ReferenceError> {
    ...
    pub(crate) fn get_or_create_final_norm_gpu(
        &self,
    ) -> Result<CachedWeightedRmsNormGpuCacheEntry, ReferenceError> {
    ...
    pub(crate) fn get_or_create_pack_f16_pairs_gpu(
        &self,
        len: usize,
    ...
    pub(crate) fn get_or_create_vector_add_gpu(
        &self,
        len: usize,
    ...
    pub(crate) fn get_or_create_swiglu_combined_gpu(
        &self,
    ...
    pub(crate) fn get_or_create_swiglu_pack_f16_pairs_gpu(
        &self,
