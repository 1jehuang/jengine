...
impl CachedGpuAttentionBlockRunner {
    ...
    pub fn run_with_resident_kv(
        &mut self,
        query: &[f32],
        key_buffer: ash::vk::Buffer,
        key_len: usize,
        key_buffer_size: u64,
        value_buffer: ash::vk::Buffer,
        value_len: usize,
        ...
        let zeros = vec![0.0f32; self.hidden];
        let shared_context = self.attention_runner.shared_context().clone();
        let attention_report = self
            .attention_runner
            .run_resident_with_query_and_kv_buffers(
                query,
                &shared_context,
                key_buffer,
                key_len,
    ...
    pub fn run_with_resident_query_and_kv(
        &mut self,
